"""
构建 Ultimate v3 版本 EXE 的脚本。
会将 link_monitor_ultimate_v3.py 打包成独立 EXE，并把 Playwright 浏览器一并打包。
"""
...
def build_exe():
    script_name = "link_monitor_ultimate_v3.py"
    exe_name = "WPP_MD_链接监测工具_Ultimate_v3"
    dist_dir = "dist"
    build_dir = "build_ultimate_v3"
    browsers_dir = "browsers"
    csv_sample = "yilideeplink.csv"

    print("=" * 60)
    print("WPP MD 小红书链接监测工具 v3.0 Ultimate - EXE打包程序")
    print("=" * 60)
    print()
